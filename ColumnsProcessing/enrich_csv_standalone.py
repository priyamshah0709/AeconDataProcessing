...
def enrich_csv(input_csv_path: str, output_csv_path: str, output_excel_path: Optional[str] = None) -> None:
    ...
    each row with account fields, then writes the enriched data to CSV and
    optionally Excel format.
    ...
    with open(input_csv_path, "r", encoding=detected_encoding, newline="") as infile:
        # Use QUOTE_MINIMAL and set doublequote=True to handle quote escaping
        # This helps with malformed quotes in the data like "1/2"""
